...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://rtnglobal.site/case-studies',
    languages: {
      'en-US': 'https://rtnglobal.site/case-studies',
      'en-GB': 'https://rtnglobal.site/case-studies',
      'fr': 'https://rtnglobal.site/fr/case-studies',
      'de': 'https://rtnglobal.site/de/case-studies',
      'es': 'https://rtnglobal.site/es/case-studies',
    }
  },
  openGraph: {
